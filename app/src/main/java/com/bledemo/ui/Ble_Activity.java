...
import com.bledemo.service.BluetoothLeService;
...
public class Ble_Activity extends Activity implements OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.send_btn:
                String secondTimestampTwo = getSecondTimestampTwo(new Date());

                //                String s = String.valueOf(secondTimestampTwo);
                // TODO Auto-generated method stub
                String mdate = "{" + secondTimestampTwo + "}";
                Log.d(TAG, "=====" + mdate);
                byte[] buff = mdate.getBytes();
